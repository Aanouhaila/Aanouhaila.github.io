Ce projet porte sur la création d'un audio player personnalisé permettant d'assurer un ensemble de fonctionnalités, vous trouvez ci-joint l'affichage de ce dernier.
